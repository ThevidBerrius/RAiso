...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <div>
            ...
            <asp:GridView ID="GV_Stationery" runat="server" AutoGenerateColumns="False" OnRowDeleting="GV_Stationery_RowDeleting" OnSelectedIndexChanged="GV_Stationery_SelectedIndexChanged">
                <Columns>
